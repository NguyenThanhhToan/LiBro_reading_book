...
class BooksTopViewScreen extends StatefulWidget {

  const BooksTopViewScreen({super.key});

  @override
  State<BooksTopViewScreen> createState() => _BooksByCategoryScreenState();
}

class _BooksByCategoryScreenState extends State<BooksTopViewScreen> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: bookVM.isLoading
            ...
            itemCount: bookVM.topLikeBooks.length,
            itemBuilder: (context, index) {
              final book = bookVM.topLikeBooks[index];
